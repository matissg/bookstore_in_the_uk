...
The bookstore company does not have internal software engineering and DevOps teams so it is decided to build [Shopify](https://www.shopify.com/ie/blog/what-is-shopify) store for the bookstore in the UK purposes. Shopify is one of the most powerful and complete commerce platforms and is capable of handling millions of items and customers.
...
Expected technical capability characteristics of the bookstore website:
 ...
 - first content pain under 1 second
...
Enhanced e-commerce setup is required:
 ...
 - "Enhanced Ecommerce" enabled in Shopify online store preferences
